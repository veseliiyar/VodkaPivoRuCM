...
public abstract partial class SharedRadioDeviceSystem : EntitySystem
{
    ...
    private void OnListen(Entity<RadioMicrophoneComponent> ent, ref ListenEvent args)
    {
        ...
        if (!CanRelaySpeech(ent, args.Source))
            return;
    ...
    /// <summary>
    /// Allows platform-specific radio implementations to reject a microphone relay.
    /// </summary>
    protected virtual bool CanRelaySpeech(Entity<RadioMicrophoneComponent> ent, EntityUid source)
    {
        return true;
    }
    ...
    [SubscribeLocalEvent]
    protected virtual void OnReceiveRadio(Entity<RadioSpeakerComponent> ent, ref RadioReceiveEvent args)
    {
