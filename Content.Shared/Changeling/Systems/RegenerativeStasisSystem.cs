...
public sealed partial class RegenerativeStasisSystem : EntitySystem
{
    ...
    public void ExitStasis(Entity<RegenerativeStasisActionComponent?> ent, EntityUid target)
    {
        ...
        {
            var referenceVolume = _bloodstream.GetReferenceVolume((target, bloodstream));
            _bloodstream.TryRegulateBloodLevel((target, bloodstream), referenceVolume);
            _bloodstream.TrySetBleedAmount((target, bloodstream), 0f);
        }
