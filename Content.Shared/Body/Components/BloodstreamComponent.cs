...
public sealed partial class BloodstreamComponent : Component
{
    ...
    /// <summary>
    /// Whether external bleeding also samples foreign chemicals from the bloodstream when a puddle is created.
    /// Reference blood reagents are always spilled independently of this setting.
    /// </summary>
    [DataField, AutoNetworkedField]
