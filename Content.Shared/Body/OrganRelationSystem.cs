...
public sealed partial class OrganRelationSystem : EntitySystem
{
    ...
    private void OnChildShutdown(Entity<ChildOrganComponent> ent, ref ComponentShutdown args)
    {
        ...
        var ev = new OrganOrphanedEvent(parentUid);
    ...
    private void OnParentShutdown(Entity<ParentOrganComponent> ent, ref ComponentShutdown args)
    {
        ...
        foreach (var childUid in ent.Comp.Children)
        {
            ...
            var ev = new OrganOrphanedEvent(ent);
            RaiseLocalEvent(childUid, ref ev);
        }
    }
    ...
    public void Relate(Entity<ParentOrganComponent?> parent, Entity<ChildOrganComponent?> child)
    {
        ...
        var ev = new OrganRelatedEvent(parent);
...
/// <summary>
/// Raised on an organ after its parent relationship has been established.
/// </summary>
[ByRefEvent]
public readonly record struct OrganRelatedEvent(EntityUid Parent);

/// <summary>
/// Raised on an organ after its parent relationship has been removed.
/// </summary>
[ByRefEvent]
public readonly record struct OrganOrphanedEvent(EntityUid OldParent);
