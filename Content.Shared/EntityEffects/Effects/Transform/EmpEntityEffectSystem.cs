...
public sealed partial class EmpEntityEffectSystem : EntityEffectSystem<TransformComponent, Emp>
{
    ...
    {
        var quantity = args.ReagentContext is { } context ? (float) context.Quantity.Quantity : args.Scale;
        var range = MathF.Min(args.Effect.RangeModifier * quantity, args.Effect.MaxRange);
