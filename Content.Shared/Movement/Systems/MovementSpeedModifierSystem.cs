...
namespace Content.Shared.Movement.Systems
{
    public sealed partial class MovementSpeedModifierSystem : EntitySystem
    {
        ...
        private void OnModMapInit(Entity<MovementSpeedModifierComponent> ent, ref MapInitEvent args)
        {
            ...
            ent.Comp.Friction = _frictionModifier * MovementSpeedModifierComponent.DefaultFriction * ent.Comp.BaseFriction;
            ent.Comp.FrictionNoInput = _frictionModifier * MovementSpeedModifierComponent.DefaultFrictionNoInput * ent.Comp.BaseFriction;
            Dirty(ent);
        }
        ...
        public void RefreshMovementSpeedModifiers(Entity<MovementSpeedModifierComponent?> ent)
        {
            ...
            if (TryComp(ent.Owner, out RMCRestComponent? rest) && rest.Resting)
            {
        ...
        /// <see cref="MovementSpeedModifierComponent.BaseFriction"/> scales both default physical damping baselines
        /// before inventory, status, and contact modifiers are applied.
        /// </summary>
        /// <param name="ent">The entity we're refreshing modifiers for</param>
        public void RefreshFrictionModifiers(Entity<MovementSpeedModifierComponent?> ent)
        {
            ...
            {
                Friction = MovementSpeedModifierComponent.DefaultFriction * ent.Comp.BaseFriction,
                FrictionNoInput = MovementSpeedModifierComponent.DefaultFrictionNoInput * ent.Comp.BaseFriction,
