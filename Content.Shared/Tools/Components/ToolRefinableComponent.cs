...
/// </summary>
[RegisterComponent, NetworkedComponent, AutoGenerateComponentState, Access(typeof(ToolRefinableSystem))]
public sealed partial class ToolRefinableComponent : Component
{
    /// <summary>
    /// Tool entities that already have an active refinement do-after for this target.
    /// </summary>
    public readonly HashSet<EntityUid> ActiveTools = [];
    ...
    /// <summary>
    /// Optional utensil type that the refining tool must have in addition to <see cref="QualityNeeded"/>.
    /// </summary>
    [DataField, AutoNetworkedField]
    public UtensilType RequiredUtensil = UtensilType.None;
