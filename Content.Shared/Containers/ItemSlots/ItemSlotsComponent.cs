...
public sealed partial class ItemSlot
{
    ...
    /// <summary>
    /// Creates an independent slot configuration without copying its backing container or local-registration state.
    /// </summary>
    ...
    /// <summary>
    /// Copies the serialized slot configuration without copying runtime ownership state.
    /// </summary>
    public void CopyFrom(ItemSlot other)
    {
        // These configuration objects are mutable reference types, but are treated as immutable by item slots.
        ...
        Name = other.Name;
        StartingItem = other.StartingItem;
        Locked = other.Locked;
        ...
        EjectOnDeconstruct = other.EjectOnDeconstruct;
        EjectOnBreak = other.EjectOnBreak;
