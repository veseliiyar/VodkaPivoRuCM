...
public enum ActionState : byte
{
    ...
    /// <summary>Appearance key. Runtime-assigned SpriteSpecifier for the toggled icon.</summary>
    DynamicIconToggled,
...
/// <summary>
/// Raised directed on an action after its shutdown cleanup has completed.
/// </summary>
[ByRefEvent]
public readonly record struct ActionVisualsShutdownEvent;
