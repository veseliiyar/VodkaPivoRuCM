...
public sealed partial class DrainSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        {
            // Deletion sweeps can leave an entity query entry alive while its transform hierarchy is terminating.
            ...
            // ResolveSolution trusts a populated cache. Clear stale references before asking it to resolve again.
            ...
            if (drain.AutoDrain)
            {
                ...
                {
                    // Overlapping drains can queue the same puddle for deletion in one update.
