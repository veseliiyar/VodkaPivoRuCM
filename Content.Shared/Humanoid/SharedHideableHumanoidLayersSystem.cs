...
public abstract partial class SharedHideableHumanoidLayersSystem : EntitySystem
{
        ...
        SlotFlags slot)
    {
        ...
        var evt = new HumanoidLayerVisibilityChangedEvent(layer, !IsLayerOccluded(ent.Comp, layer));
        RaiseLocalEvent(ent, ref evt);
    }

    /// <summary>
    /// Sets occlusion that persists independently of equipment, such as a layer hidden by severance.
    /// </summary>
    public virtual void SetPermanentLayerOcclusion(
        Entity<HideableHumanoidLayersComponent?> ent,
        HumanoidVisualLayers layer,
        bool hidden)
    {
        ...
        var dirty = hidden
            ? ent.Comp.PermanentlyHiddenLayers.Add(layer)
            : ent.Comp.PermanentlyHiddenLayers.Remove(layer);
    ...
    public static bool IsLayerOccluded(
        HideableHumanoidLayersComponent component,
        HumanoidVisualLayers layer)
    {
        return component.HiddenLayers.ContainsKey(layer) || component.PermanentlyHiddenLayers.Contains(layer);
    }
}
