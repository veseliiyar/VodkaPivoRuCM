...
public sealed partial class HideableHumanoidLayersComponent : Component
{
    ...
    /// <summary>
    /// Layers hidden independently of equipment, such as limbs hidden by severance.
    /// Equipment changes must not reveal a layer while it remains in this set.
    /// </summary>
    [DataField, AutoNetworkedField]
    public HashSet<HumanoidVisualLayers> PermanentlyHiddenLayers = new();
