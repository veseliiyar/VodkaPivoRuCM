...
public abstract partial class SharedFlashSystem : EntitySystem
{
    ...
    {
        TryFlash(target, user, used, flashDuration, slowTo, displayPopup, melee, stunDuration);
    }

    /// <summary>
    /// Flashes an entity for a duration in milliseconds and returns whether the flash was applied.
    /// </summary>
