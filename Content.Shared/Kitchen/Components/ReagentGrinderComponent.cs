...
public sealed partial class ReagentGrinderComponent : Component
{
    ...
    /// <summary>
    /// Maximum distance at which this grinder can link to a smart fridge.
    /// </summary>
    [DataField]
    public float LinkDistance = 8;

    /// <summary>
    /// Maximum distance at which an existing smart-fridge link remains valid.
    /// </summary>
    [DataField]
    public float LinkLimit = 16;

    /// <summary>
    /// The smart fridge currently linked to this grinder.
    /// </summary>
    [DataField, AutoNetworkedField]
