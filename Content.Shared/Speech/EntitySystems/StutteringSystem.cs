...
{
    public static readonly EntProtoId StutterEffect = "StatusEffectStutter";
    ...
    /// <summary>
    /// Removes time from the stuttering speech status effect.
    /// </summary>
    [PublicAPI]
    public void DoRemoveStutterTime(EntityUid uid, double timeRemoved)
    {
        _statusEffects.TryRemoveTime(uid, StutterEffect, TimeSpan.FromSeconds(timeRemoved));
    }
}
