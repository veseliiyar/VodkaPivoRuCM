...
/// <param name="requirementsOverride">Optional requirements that replace prototype requirements for this check.</param>
[ByRefEvent]
public struct IsRoleAllowedEvent(
    ...
    HashSet<JobRequirement>? requirementsOverride = null)
{
    ...
    public readonly HashSet<JobRequirement>? RequirementsOverride = requirementsOverride;
