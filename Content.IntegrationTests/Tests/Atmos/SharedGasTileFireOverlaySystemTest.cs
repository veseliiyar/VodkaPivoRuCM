...
public sealed partial class SharedGasTileOverlayTest
{
        ...
        bool expectInitialChunks = true)
    {
        ...
        Assert.That(cOverlay.Chunks, expectInitialChunks ? Is.Not.Empty : Is.Empty,
            "Gas overlay chunks do not match the configured processing state on the client.");
