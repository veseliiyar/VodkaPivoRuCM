...
- type: entity
  ...
  - type: Solution
    ...
    // RMC14: These recipes create H2O, which almost immediately turns into Water and can trigger
    // a higher-priority reaction before the final-solution assertion runs.
