...
public sealed partial class BiomorphAssimilatedComponent : Component
{
    /// <summary>
...
public sealed partial class BiomorphAssimilationProfile
{
    [DataField]
    public BiomorphAppearanceSnapshot? Appearance;
...
/// </summary>
[Serializable, NetSerializable, DataDefinition]
public sealed partial class BiomorphAppearanceSnapshot
{
    [DataField]
    public int Age = 18;
