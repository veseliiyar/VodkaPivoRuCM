...
public sealed partial class BiomorphSpitSystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<BiomorphSpitComponent, BiomorphSpitActionEvent>(OnSpitAction);
    }

    private void OnSpitAction(Entity<BiomorphSpitComponent> ent, ref BiomorphSpitActionEvent args)
    {
        if (args.Handled)
            return;
