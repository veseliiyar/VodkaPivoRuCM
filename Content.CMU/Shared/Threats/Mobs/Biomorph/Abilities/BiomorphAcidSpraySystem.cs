...
/// </summary>
public sealed partial class BiomorphAcidSpraySystem : EntitySystem
{
    ...
    {
        SubscribeLocalEvent<BiomorphAcidSprayComponent, BiomorphAcidSprayActionEvent>(OnSprayAction);
    }

    private void OnSprayAction(Entity<BiomorphAcidSprayComponent> ent, ref BiomorphAcidSprayActionEvent args)
    {
        if (args.Handled)
            return;
