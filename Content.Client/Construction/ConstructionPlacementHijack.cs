...
public sealed partial class ConstructionPlacementHijack : PlacementHijack
{
    ...
    public override void StartHijack(PlacementManager manager)
    {
        ...
        // AU14 building overhaul: passing the target prototype preserves its sprite scale.
        var textures = _spriteSystem.GetPrototypeTextures(proto).ToList();
        manager.PreparePlacementTexList(textures, !CanRotate, proto);
    }
}
